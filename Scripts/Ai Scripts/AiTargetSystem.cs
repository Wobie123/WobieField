...
{
    public float memorySpan = 3.0f;//3 seconds memory
    ...
    public GameObject Target{
        get{   
            //return bestMemory.gameObject.transform.GetChild(0).gameObject;//questionable
    ...
    void Update()
    {
        memory.UpdateSenses(sensor,EnemytagName);
